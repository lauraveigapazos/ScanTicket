...
import es.udc.tfg.scanticket.rest.dtos.*;
...
import es.udc.tfg.scanticket.rest.dtos.UserDto;
...
public class UserController {
	...
	public UserDto updateProfile(@RequestAttribute Long userId, @PathVariable("id") Long id,
		...
		return UserConversor.toUserDto(
				userService.updateProfile(id, userDto.getFirstName(), userDto.getLastName(), userDto.getEmail(), userDto.getProfilePicture()));
